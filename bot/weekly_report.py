...
def build_weekly_prompt(
    ...
    lines.append(
        ...
        "What was the single most important catalyst this week and how did it affect markets? Label it in plain English as one of earnings/guidance, macro/rates, geopolitical, political trade, government contract, news, technical, sentiment, crypto, valuation, or sector rotation. Be specific.\n\n"
        ...
        "Avoid defaulting to WATCH just because markets are noisy. "
        "Use BUY or SELL when the bull/bear balance clearly points to a near-term directional trade with a catalyst, confirming data point, identifiable risk, and next-week/next-catalyst horizon. "
        ...
        "Use HOLD when the best decision is explicitly to wait or maintain a prior view. "
        ...
        "Catalyst Type: [earnings/guidance/macro/rates/inflation/geopolitical/political_trade/government_contract/news/technical/sentiment/crypto/valuation/sector_rotation/other]\n"
        "Catalyst Detail: [specific catalyst/event/data point]\n"
        "Horizon: [next week/next catalyst or named event/date]\n"
